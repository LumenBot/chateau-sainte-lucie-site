...
export const gallerySeo = {
  ...
  description:
    "Le Château de Sainte-Lucie aujourd'hui et l'expérience imaginée après travaux : suites, piscine naturelle, table d'hôtes, spa et parc au fil des lumières.",
};
...
export const galleryItems: GalleryItem[] = [
  ...
  { image: images.projTableHotes, caption: "Le dîner privatif dans les boiseries", wide: true },
